...
public class ZirnoxRender extends TileEntitySpecialRenderer<ZirnoxTE> {

	@Override
	public boolean isGlobalRenderer(ZirnoxTE fel) {
		return true;
	}

	@Override
	public void render(ZirnoxTE tileEntity,double x,double y,double z,float partialTicks,int destroyStage,float alpha) {
		GL11.glPushMatrix();
