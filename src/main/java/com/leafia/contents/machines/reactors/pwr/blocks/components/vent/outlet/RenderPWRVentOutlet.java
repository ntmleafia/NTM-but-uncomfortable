...
public class RenderPWRVentOutlet extends TileEntitySpecialRenderer<TileEntityPWRVentOutlet> {
	...
	@Override
	public boolean isGlobalRenderer(TileEntityPWRVentOutlet entity) {
		return true;
	}
	@Override
	public void render(TileEntityPWRVentOutlet entity,double x,double y,double z,float partialTicks,int destroyStage,float alpha) {
