...
public class PWRVentDuctBlock extends PWRVentBlockBase implements ILookOverlay {
	public PWRVentDuctBlock() {
	...
	public void neighborChanged(IBlockState state,World worldIn,BlockPos pos,Block blockIn,BlockPos fromPos) {
		...
		for (EnumFacing facing : EnumFacing.values()) {
			if (worldIn.getBlockState(pos.offset(facing)).getBlock() instanceof PWRVentInletBlock) {
				if (!trigger)
					trigger = true;
				else {
					trigger = false;
