...
public class ChemplantRecipes {
	...
	public static void registerRecipes() {
		...
		makeRecipe(610, "DYN_SCHRAB", new AStack[] {new ComparableStack(ModItems.particle_higgs, 1), new OreDictStack(U.ingot(), 8), new ComparableStack(ModItems.catalyst_clay, 8) }, new FluidStack[]{ new FluidStack(ModForgeFluids.COOLANT, 1000) }, new AStack[] { new ComparableStack(ModItems.particle_empty, 1), new ComparableStack(Ingots.ingot_schrabidium, 8) }, new FluidStack[]{ new FluidStack(ModForgeFluids.WATZ, 50) }, 20*30);
		...
		makeRecipe(630, "DYN_EUPH", new AStack[] {new ComparableStack(ModItems.particle_dark, 1), new OreDictStack(SA327.ingot(), 8), new ComparableStack(ModItems.catalyst_clay, 16) }, new FluidStack[]{ new FluidStack(ModForgeFluids.CRYOGEL, 2000) }, new AStack[] { new ComparableStack(ModItems.particle_empty, 1), new ComparableStack(Ingots.ingot_euphemium, 8) }, new FluidStack[]{ new FluidStack(ModForgeFluids.WATZ, 100) }, 20*60*2);
		
		makeRecipe(640, "DYN_DNT", new AStack[] {new ComparableStack(ModItems.particle_sparkticle, 1), new OreDictStack(SBD.ingot(), 8), new ComparableStack(ModItems.catalyst_clay, 32) }, new FluidStack[]{ new FluidStack(ModForgeFluids.CRYOGEL, 4000) }, new AStack[] { new ComparableStack(ModItems.particle_empty, 1), new ComparableStack(Ingots.ingot_dineutronium, 8) }, new FluidStack[]{ new FluidStack(ModForgeFluids.WATZ, 400) }, 20*60*5);
		
		makeRecipe(650, "DYN_EL", new AStack[] {new ComparableStack(ModItems.particle_digamma, 1), new OreDictStack(DNT.ingot(), 16), new ComparableStack(ModItems.catalyst_clay, 64) }, new FluidStack[]{ new FluidStack(ModForgeFluids.CRYOGEL, 8000) }, new AStack[] { new ComparableStack(ModItems.particle_empty, 1), new ComparableStack(Ingots.ingot_electronium, 1) }, new FluidStack[]{ new FluidStack(ModForgeFluids.WATZ, 800) }, 20*60*10);
