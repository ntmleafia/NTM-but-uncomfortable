...
public class MissileCustomNukePacket implements IMessage {

	int x, y, z, identifier;
	int dimension;
	public final Map<Byte,Object> signal = new HashMap<>();

	public MissileCustomNukePacket() {
	}
	public MissileCustomNukePacket(BlockPos pos, String identifier) {
		x = pos.getX();
		y = pos.getY();
		z = pos.getZ();
	...
	public MissileCustomNukePacket __write(byte key, Object value) {
	...
	public static MissileCustomNukePacket _start(TileEntity entity) {
		MissileCustomNukePacket packet = new MissileCustomNukePacket(entity.getPos(),((LeafiaPacketReceiver)entity).getPacketIdentifier());
	...
	public static class Handler implements IMessageHandler<MissileCustomNukePacket,IMessage> {
		@SideOnly(Side.CLIENT)
		public void handleLocal(MissileCustomNukePacket m, MessageContext ctx) {
		...
		@Override
		public IMessage onMessage(MissileCustomNukePacket m, MessageContext ctx) {
