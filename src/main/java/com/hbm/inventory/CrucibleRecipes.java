...
public class CrucibleRecipes {
	...
	public static void registerDefaults() {
		...
		recipes.put(2, new CrucibleRecipe(2, "crucible.steel", 2, new ItemStack(ingot_steel))
		...
		recipes.put(3, new CrucibleRecipe(3, "crucible.redcopper", 2, new ItemStack(Ingots.ingot_red_copper))
		...
		recipes.put(4, new CrucibleRecipe(4, "crucible.aa", 2, new ItemStack(Ingots.ingot_advanced_alloy))
		...
		recipes.put(5, new CrucibleRecipe(5, "crucible.hss", 9, new ItemStack(Ingots.ingot_dura_steel))
		...
		recipes.put(6, new CrucibleRecipe(6, "crucible.ferro", 3, new ItemStack(Ingots.ingot_ferrouranium))
		...
		recipes.put(9, new CrucibleRecipe(9, "crucible.star", 3, new ItemStack(Ingots.ingot_starmetal))
		...
		recipes.put(10, new CrucibleRecipe(10, "crucible.magtung", 3, new ItemStack(Ingots.ingot_magnetized_tungsten))
		...
		recipes.put(12, new CrucibleRecipe(12, "crucible.bscco", 3, new ItemStack(Ingots.ingot_bscco))
