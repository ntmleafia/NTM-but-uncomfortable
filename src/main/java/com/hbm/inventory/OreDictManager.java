...
public class OreDictManager {
	...
	public static void registerOres() {
		...
		GOLD 																																			.dust(Powders.powder_gold)																						.crystal(Crystals.crystal_gold)		.plate(plate_gold)			.ore(ore_gneiss_gold);
		...
		CU																													.ingot(Ingots.ingot_copper)		.dust(Powders.powder_copper)									.block(block_copper)							.crystal(Crystals.crystal_copper)		.plate(plate_copper)	.ore(ore_copper, cluster_copper, ore_gneiss_copper, ore_meteor_copper);
		...
		AL																													.ingot(Ingots.ingot_aluminium)		.dust(Powders.powder_aluminium)									.block(block_aluminium)							.crystal(Crystals.crystal_aluminium)		.plate(plate_aluminium)	.ore(ore_aluminium, cluster_aluminium, ore_meteor_aluminium);
		PB															.nugget(Nuggies.nugget_lead)									.ingot(Ingots.ingot_lead)			.dust(Powders.powder_lead)										.block(block_lead)								.crystal(Crystals.crystal_lead)			.plate(plate_lead)		.ore(ore_lead, ore_meteor_lead);
		...
		ALLOY																												.ingot(Ingots.ingot_advanced_alloy).dust(Powders.powder_advanced_alloy)							.block(block_advanced_alloy)													.plate(plate_advanced_alloy);
		...
		SA326	.rad(HazardRegistry.sa326)	.blinding(50F)			.nugget(Nuggies.nugget_schrabidium)	.billet(Billets.billet_schrabidium)	.ingot(Ingots.ingot_schrabidium)	.dust(Powders.powder_schrabidium)								.block(block_schrabidium)						.crystal(Crystals.crystal_schrabidium)	.plate(plate_schrabidium).ore(ore_schrabidium, ore_gneiss_schrabidium, ore_nether_schrabidium)	.oreNether(ore_nether_schrabidium);
