...
public class ItemEnumMultiColor extends ItemBase implements  IDynamicModels {
    ...
    public ItemEnumMultiColor(String registryName, Class<? extends Enum> theEnum, boolean multiName, boolean multiTexture) {
        ...
        INSTANCES.add(this);
        this.textures = getTextures(registryName);
    }

    public String[] getTextures(String registryName){
        return Arrays.stream(theEnum.getEnumConstants())
