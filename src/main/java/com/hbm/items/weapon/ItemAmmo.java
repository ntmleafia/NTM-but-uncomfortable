...
public class ItemAmmo extends Item {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> list, ITooltipFlag flagIn) {
		...
		if(this == Armory.ammo_75bolt_incendiary) {
		...
		if(this == Armory.ammo_nuke_safe) {
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.dblast"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.noblock"));
		}
		if(this == Armory.ammo_nuke_pumpkin) {
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.nonuke"));
		}

		//MIRV
		if(this == Armory.ammo_mirv_low) {
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.dblast"));
		}
		if(this == Armory.ammo_mirv_high) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.blast"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.fallout"));
		}
		if(this == Armory.ammo_mirv_safe) {
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.dblast"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.noblock"));
		}
		if(this == Armory.ammo_mirv_special) {
		...
		// FUEL
		if(this == Armory.ammo_fuel_napalm) {
		...
		if(this == Armory.ammo_fuel_phosphorus) {
		...
		if(this == Armory.ammo_fuel_vaporizer) {
		...
		// 12 GAUGE
		if(this == Armory.ammo_44_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphorburn"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.warcrime"));
		...
		if(this == Armory.ammo_50bmg_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphorburn"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.warcrime"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.nopen"));
		}
		if(this == Armory.ammo_50bmg_ap) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_rocket_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphor"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.warcrime"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_grenade_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphor"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.warcrime"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_grenade_kampf) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.rocketprop"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.blast"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.accuracy"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_12gauge_incendiary) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.inc"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_12gauge_shrapnel) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.bounce"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_12gauge_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
		...
		if(this == Armory.ammo_12gauge_marauder) {
		...
		if(this == Armory.ammo_20gauge_incendiary) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.inc"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_20gauge_shrapnel) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.bounce"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_20gauge_explosive) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.explosive"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_20gauge_caustic) {
		...
		if(this == Armory.ammo_20gauge_shock) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
		...
		if(this == Armory.ammo_20gauge_wither) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.wither"));
		}
		if(this == Armory.ammo_20gauge_sleek) {
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.gaugesleek"));
		}

		// .357 MAGNUM
		if(this == Armory.ammo_357_desh) {
		...
		// .44 MAGNUM
		if(this == Armory.ammo_44_ap) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_44_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_44_pip) {
		...
		// 5mm
		if(this == Armory.ammo_5mm_explosive) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.explosive"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_5mm_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_5mm_star) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.starmetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		...
		// 9mm
		if(this == Armory.ammo_9mm_ap) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_9mm_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_9mm_rocket) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.rocket"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.uhhh"));
		}

		// .22LR
		if(this == Armory.ammo_22lr_ap) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}

		// .50 BMG
		if(this == Armory.ammo_50bmg_incendiary) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.inc"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_50bmg_explosive) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.explosive"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_50bmg_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_50bmg_star) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.starmetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_50bmg_sleek) {
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.meteorite"));
		}

		// .50 AE
		if(this == Armory.ammo_50ae_ap) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_50ae_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_50ae_star) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.starmetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		...
		if(this == Armory.ammo_rocket_sleek) {
		...
		if(this == Armory.ammo_rocket_nuclear) {
		...
		if(this == Armory.ammo_rocket_rpc) {
		...
		// 40mm GRENADES
		if(this == Armory.ammo_grenade_he) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.blast"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_grenade_incendiary) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.incexplosive"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_grenade_toxic) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.8"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.noexplosive"));
		}
		if(this == Armory.ammo_grenade_concussion) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.blast"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.noblock"));
		}
		if(this == Armory.ammo_grenade_finned) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.11"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.dblast"));
		}
		if(this == Armory.ammo_grenade_sleek) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.blast"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.jolt"));
		}
		if(this == Armory.ammo_grenade_nuclear) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.nuclear"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.range"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		...
		if(this == Armory.ammo_4gauge_semtex) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.explosive"));
		...
		if(this == Armory.ammo_4gauge_balefire) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.explosive"));
		...
		if(this == Armory.ammo_4gauge_kampf) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.explosive"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.rocketprop"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.accuracy"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
		...
		if(this == Armory.ammo_4gauge_sleek) {
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.gaugesleek"));
		}
		if(this == Armory.ammo_4gauge_flechette) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.dbounce"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_4gauge_flechette_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphorburn"));
		...
		// 5.56mm
		if(this == Armory.ammo_556_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphorburn"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.warcrime"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.nopen"));
		}
		if(this == Armory.ammo_556_ap) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		}
		if(this == Armory.ammo_556_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_556_star) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.starmetal"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.highwear"));
		}
		if(this == Armory.ammo_556_sleek) {
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.meteorite"));
		}
		if(this == Armory.ammo_556_flechette) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.dbounce"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.nopen"));
		}
		if(this == Armory.ammo_556_flechette_incendiary) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.inc"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.dbounce"));
			list.add(TextFormatting.RED + "- " + I18nUtil.resolveKey("ammo.trait.wear"));
		...
		if(this == Armory.ammo_556_flechette_phosphorus) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.phosphorburn"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.highwarcrime"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.dbounce"));
		...
		if(this == Armory.ammo_556_flechette_du) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.highdamage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.pen"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.heavymetal"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.dbounce"));
		...
		if(this == Armory.ammo_5mm_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
		...
		if(this == Armory.ammo_9mm_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
		...
		if(this == Armory.ammo_22lr_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
		...
		if(this == Armory.ammo_50bmg_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
		...
		if(this == Armory.ammo_50ae_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
		...
		if(this == Armory.ammo_556_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
		...
		if(this == Armory.ammo_556_flechette_chlorophyte) {
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.damage"));
			list.add(TextFormatting.BLUE + "+ " + I18nUtil.resolveKey("ammo.trait.dwear"));
			list.add(TextFormatting.DARK_GREEN + "* " + I18nUtil.resolveKey("ammo.trait.chlorophyte"));
			list.add(TextFormatting.YELLOW + "* " + I18nUtil.resolveKey("ammo.trait.homing"));
