...
public class ItemMold extends Item implements IHasCustomMetaModels {
	...
	public ItemMold(String s) {
		...
		registerMold(new MoldSingle(	17, S, "c357", new ItemStack(Armory.casing_357), Mats.MAT_COPPER, MaterialShapes.PLATE.q(1)));
		registerMold(new MoldSingle(	18, S, "c44", new ItemStack(Armory.casing_44), Mats.MAT_COPPER, MaterialShapes.PLATE.q(1)));
		registerMold(new MoldSingle(	19, S, "c9", new ItemStack(Armory.casing_9), Mats.MAT_COPPER, MaterialShapes.PLATE.q(1)));
		registerMold(new MoldSingle(	20, S, "c50", new ItemStack(Armory.casing_50), Mats.MAT_COPPER, MaterialShapes.PLATE.q(1)));
		registerMold(new MoldSingle(	21, S, "cbuckshot", new ItemStack(Armory.casing_buckshot), Mats.MAT_COPPER, MaterialShapes.PLATE.q(1)));
