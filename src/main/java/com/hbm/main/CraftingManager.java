...
public class CraftingManager {
	...
	public static void reg2(){
		...
		addShapelessAuto(new ItemStack(ModBlocks.dfc_receiver, 1), new Object[] { ModItems.dfcsh_beam, ModItems.dfcsh_cable, ModItems.dfcsh_corner, ModItems.dfcsh_core, ModItems.hull_small_steel, ModItems.dfcsh_front, ModItems.dfcsh_corner, ModItems.dfcsh_beam, ModItems.dfcsh_beam });
