...
public class BobmazonOfferFactory {
	...
	public static void init() {
		...
		int inflation = 5;
		materials.add(new Offer(new ItemStack(Ingots.ingot_uranium), Requirement.NUCLEAR, 6 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_u233), Requirement.NUCLEAR, 20 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_u238), Requirement.NUCLEAR, 15 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_th232), Requirement.NUCLEAR, 4 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_plutonium), Requirement.NUCLEAR, 25 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_titanium), Requirement.STEEL, 2 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_copper), Requirement.STEEL, 2 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_red_copper), Requirement.STEEL, 4 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_tungsten), Requirement.STEEL, 3 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_aluminium), Requirement.STEEL, 2 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_steel), Requirement.STEEL, 4 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_lead), Requirement.STEEL, 2 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_polymer), Requirement.OIL, 8 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_uranium_fuel), Requirement.NUCLEAR, 18 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_thorium_fuel), Requirement.NUCLEAR, 16 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_desh), Requirement.OIL, 16 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_saturnite), Requirement.STEEL, 8 * inflation));
		materials.add(new Offer(new ItemStack(Ingots.ingot_lithium), Requirement.CHEMICS, 6 * inflation));
		...
		materials.add(new Offer(ItemBattery.getFullBattery(Batteries.battery_advanced), Requirement.ASSEMBLY, 15 * inflation));
		materials.add(new Offer(ItemBattery.getFullBattery(Batteries.battery_lithium), Requirement.CHEMICS, 30 * inflation));
		...
		weapons.add(new Offer(new ItemStack(Armory.turret_cheapo_ammo), Requirement.ASSEMBLY, 20 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.turret_control), Requirement.CHEMICS, 35 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.turret_chip), Requirement.CHEMICS, 80 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.turret_biometry), Requirement.CHEMICS, 15 * inflation));
		...
		weapons.add(new Offer(new ItemStack(Armory.gun_revolver), Requirement.ASSEMBLY, 15 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_revolver_nopip), Requirement.ASSEMBLY, 20 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_minigun), Requirement.OIL, 100 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_panzerschreck), Requirement.ASSEMBLY, 95 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_hk69), Requirement.ASSEMBLY, 60 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_uzi), Requirement.OIL, 80 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_lever_action), Requirement.ASSEMBLY, 60 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_bolt_action), Requirement.ASSEMBLY, 35 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.gun_revolver_ammo, 6), Requirement.OIL, 12 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_357_desh, 6), Requirement.OIL, 36 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_44, 6), Requirement.OIL, 12 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_44_ap, 6), Requirement.OIL, 18 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_5mm, 50), Requirement.OIL, 50 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_5mm_du, 50), Requirement.OIL, 75 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_rocket), Requirement.OIL, 5 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_rocket_incendiary), Requirement.OIL, 8 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_rocket_sleek), Requirement.OIL, 12 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_grenade), Requirement.OIL, 4 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_grenade_incendiary), Requirement.OIL, 6 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_grenade_sleek), Requirement.OIL, 10 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_22lr, 32), Requirement.OIL, 24 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_22lr_ap, 32), Requirement.OIL, 32 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_20gauge, 6), Requirement.OIL, 18 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_20gauge_slug, 6), Requirement.OIL, 20 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.ammo_20gauge_flechette, 6), Requirement.OIL, 22 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.grenade_if_generic, 3), Requirement.CHEMICS, 15 * inflation));
		weapons.add(new Offer(new ItemStack(Armory.grenade_if_he, 3), Requirement.CHEMICS, 25 * inflation));
		...
		special.add(new Offer(new ItemStack(Armory.gun_lever_action), Requirement.HIDDEN, 5 * inflation));
		special.add(new Offer(new ItemStack(Armory.ammo_20gauge, 24), Requirement.HIDDEN, 5 * inflation));
		special.add(new Offer(new ItemStack(Armory.ammo_20gauge_incendiary, 24), Requirement.HIDDEN, 7 * inflation));
		special.add(new Offer(new ItemStack(Armory.gun_uzi_silencer, 1), Requirement.HIDDEN, 5 * inflation));
		special.add(new Offer(new ItemStack(Armory.ammo_22lr, 64), Requirement.HIDDEN, 3 * inflation));
		special.add(new Offer(new ItemStack(Armory.ammo_22lr_ap, 64), Requirement.HIDDEN, 4 * inflation));
		special.add(new Offer(new ItemStack(Armory.gun_hk69, 24), Requirement.HIDDEN, 8 * inflation));
		special.add(new Offer(new ItemStack(Armory.ammo_grenade, 6), Requirement.HIDDEN, 4 * inflation));
		special.add(new Offer(new ItemStack(Armory.ammo_grenade_sleek, 6), Requirement.HIDDEN, 6 * inflation));
		...
		special.add(new Offer(new ItemStack(Ingots.ingot_steel, 64), Requirement.HIDDEN, 2 * inflation));
		special.add(new Offer(new ItemStack(Ingots.ingot_copper, 64), Requirement.HIDDEN, 2 * inflation));
		special.add(new Offer(new ItemStack(Ingots.ingot_red_copper, 64), Requirement.HIDDEN, 2 * inflation));
		special.add(new Offer(new ItemStack(Ingots.ingot_titanium, 64), Requirement.HIDDEN, 2 * inflation));
		special.add(new Offer(new ItemStack(Ingots.ingot_tungsten, 64), Requirement.HIDDEN, 2 * inflation));
		...
		special.add(new Offer(new ItemStack(Armory.crucible, 1, 3), Requirement.STEEL, 10 * inflation));
		...
		special.add(new Offer(new ItemStack(Billets.billet_yharonite, 4), Requirement.HIDDEN, 160 * inflation));
		special.add(new Offer(new ItemStack(Ingots.ingot_electronium, 1), Requirement.HIDDEN, 160 * inflation));
