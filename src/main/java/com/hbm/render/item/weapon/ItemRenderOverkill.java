	...
	public void renderByItem(ItemStack stack) {
		...
		case FIRST_PERSON_RIGHT_HAND:
			...
			if (type == TransformType.FIRST_PERSON_RIGHT_HAND) {
				if (stack.getItem() == Armory.gun_revolver_pip || stack.getItem() == Armory.gun_revolver_nopip ||
					stack.getItem() == Armory.gun_revolver_blackjack || stack.getItem() == Armory.gun_revolver_red || stack.getItem() == Armory.gun_revolver_silver) {
		...
		case GROUND:
			...
			GL11.glRotated(180, 1, 0, 0);
			if (stack.getItem() == Armory.gun_revolver_pip || stack.getItem() == Armory.gun_revolver_nopip || stack.getItem() == Armory.gun_revolver_blackjack || stack.getItem() == Armory.gun_revolver_red || stack.getItem() == Armory.gun_revolver_silver) {
