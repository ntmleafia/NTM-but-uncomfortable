	...
	public void renderByItem(ItemStack item) {
		...
		case FIRST_PERSON_RIGHT_HAND:
			if(type == TransformType.FIRST_PERSON_LEFT_HAND) {
				...
				} else if(item.getItem() == Armory.gun_deagle) {
					GL11.glTranslated(0, 0, 0.2);
					GL11.glRotated(20, 0, 0, 1);
					GL11.glRotated(95, 0, 1, 0);
					GL11.glScaled(0.2, 0.2, 0.2);
				} else if(item.getItem() == Armory.gun_ks23) {
					GL11.glTranslated(-0.1, 0.25, 0.5);
					GL11.glRotated(30, 0, 0, 1);
					GL11.glRotated(95, 0, 1, 0);
				} else if(item.getItem() == Armory.gun_flamer) {
					GL11.glTranslated(0.3, -0.6, 0);
					GL11.glRotated(26, 0, 0, 1);
					GL11.glRotated(95, 0, 1, 0);
					GL11.glScaled(0.5, 0.5, 0.5);
				} else if(item.getItem() == Armory.gun_flechette) {
		...
		if(item.getItem() == Armory.gun_flechette) {
			GlStateManager.shadeModel(GL11.GL_SMOOTH);
			renderFlechette();
			GlStateManager.shadeModel(GL11.GL_FLAT);
		}
