...
public class RenderZirnox extends TileEntitySpecialRenderer<TileEntityReactorZirnox> {
	...
	@Override
	public boolean isGlobalRenderer(TileEntityReactorZirnox fel) {
		return true;
	}

	@Override
	public void render(TileEntityReactorZirnox tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		GL11.glPushMatrix();
