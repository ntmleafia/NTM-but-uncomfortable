...
public class RenderCrystallizer extends TileEntitySpecialRenderer<CrystallizerCopyBase> {

	@Override
	public boolean isGlobalRenderer(CrystallizerCopyBase te) {
		return true;
	}
	
	@Override
	public void render(CrystallizerCopyBase crys, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		GL11.glPushMatrix();
	...
	public void renderFill(CrystallizerCopyBase crys){
